...
In each folder, we include a README.md with details about how to setup and run the code. Please note that we use Google Translate API for creating the dataset - you will need your own API key to pay for these services. 
